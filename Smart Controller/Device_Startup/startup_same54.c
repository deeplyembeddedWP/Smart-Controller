...
void NonMaskableInt_Handler  ( void ) __attribute__ ((weak, alias("NonMaskableInt_Dummy_Handler")));
void HardFault_Handler       ( void ) __attribute__ ((weak, alias("HardFault_Dummy_Handler")));
void MemManagement_Handler   ( void ) __attribute__ ((weak, alias("MemManagement_Dummy_Handler")));
void BusFault_Handler        ( void ) __attribute__ ((weak, alias("BusFault_Dummy_Handler")));
void UsageFault_Handler      ( void ) __attribute__ ((weak, alias("UsageFault_Dummy_Handler")));
